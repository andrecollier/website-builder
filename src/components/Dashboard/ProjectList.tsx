                ...
                <div className="flex-shrink-0 flex items-center gap-2">
                  {deleteConfirmId === project.id ? (
                    ...
                    <>
                      ...
                      {/* Components Button - opens component gallery */}
                      {project.status === 'completed' && (
                        <a
                          href="http://localhost:3002/preview/components"
                          target="_blank"
                          ...
                          className={cn(
                            ...
                            'hover:bg-[rgb(var(--primary)/0.2)]',
                            'opacity-0 group-hover:opacity-100',
                            'focus:outline-none focus:opacity-100 focus:ring-2 focus:ring-[rgb(var(--primary)/0.3)]',
                            'transition-all duration-150',
                            'flex items-center gap-1'
                          )}
                          aria-label={`View components: ${project.name}`}
                        >
                          Components
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
